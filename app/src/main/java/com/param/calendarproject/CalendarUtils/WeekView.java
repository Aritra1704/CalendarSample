...
import com.param.calendarproject.CalendarUtils.DateTimeInterpreter;
import com.param.calendarproject.CalendarUtils.MonthLoader;
import com.param.calendarproject.CalendarUtils.WeekViewEvent;
import com.param.calendarproject.CalendarUtils.WeekViewLoader;
...
public class WeekView extends View {
    ...
    private void drawHeaderRowAndEvents(Canvas canvas) {
        ...
        for (int dayNumber=leftDaysWithGaps+1; dayNumber <= leftDaysWithGaps + mNumberOfVisibleDays + 1; dayNumber++) {
            ...
            canvas.drawText(dateLabel, startPixel + mWidthPerDay / 2, mHeaderTextHeight + mHeaderRowPadding*2, sameDay ? mTodayHeaderTextPaint : mHeaderTextPaint);
            startPixel += mWidthPerDay + mColumnGap;
        }
            ...
            for (int i = 0; i < mEventRects.size(); i++) {
                if (isSameDay(mEventRects.get(i).event.getStartTime(), date)) {
                    ...
                    if (left < right &&
                        ...
                        mEventBackgroundPaint.setColor(getResources().getColor(R.color.colorAccent));
